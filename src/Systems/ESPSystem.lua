        ...
        for player, data in pairs(DrawingESP) do
            ...
            if data.Name then
                ...
                if FeatureConfig.ESP.Name then
                    ...
                    data.Name.Position = Vector2.new(rootScreen.X, headScreen.Y - 26)
                    data.Name.Color = col
                end
            end
            if data.Health and data.HealthBG then
                ...
                if FeatureConfig.ESP.Health then
                    ...
                    local barX = rootScreen.X - width / 2 - 6
            ...
            if data.Distance then
                ...
                if FeatureConfig.ESP.Distance then
                    ...
                    data.Distance.Position = Vector2.new(rootScreen.X, feetScreen.Y + 4)
