...
return function(CONFIG, DefaultLighting, Utils, DrawingManager)
    ...
    local FeatureConfig = {
        Aimbot = {
            Enabled = false, Keybind = "C",
            Hitpart = "HumanoidRootPart", AirHitpart = "Head",
            Smoothness = 1, LockMode = "Toggle",
            Prediction = {Horizontal = 0.165, Vertical = 0.100},
            TeamCheck = false, VisCheck = false,
            MaxDistance = 200, ShakeIntensity = 0, LockNPC = false,
        ...
        ESP = {
            ...
            Distance = false, Tracers = false, Skeleton = false,
            HeadDot = false, LookDir = false, TeamCheck = false,
            MaxDist = 500, Color = Color3.fromRGB(0, 200, 255),
        },
        Chams = {Enabled = false, FillColor = Color3.fromRGB(0,170,255), OutlineColor = Color3.fromRGB(255,255,255)},
        Camera = {FOV = 90},
        ...
        Extras = {
            ...
            SpeedLines = false, Wallbang = false,
        },
    }

    local State = {
        AimTarget = nil, AimHoldActive = false, AimLocked = false, AimSettleCounter = 0,
        SelectedPlayer = nil, SavedPosition = nil,
        OriginalHitboxSizes = {},
        FlyBodyVelocity = nil, FlyBodyGyro = nil,
        SpinBotAngle = 0, OrbitAngle = 0, SpinTargetAngle = 0, FOVHue = 0, FOVPulse = 0,
        LoopTeleport = false, OrbitEnabled = false, OrbitRadius = 8, OrbitSpeed = 2,
        LoopJump = false, SpinTarget = false, TpToMouse = false,
